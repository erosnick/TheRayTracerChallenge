...
Tuple reflectedColor(const World& world, const HitInfo& hitInfo, int32_t reflectionRemaining = 5);
Tuple refractedColor(const World& world, const HitInfo& hitInfo, int32_t refractionRemaining = 1);
